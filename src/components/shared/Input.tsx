...
const Input = ({name,type,placeholder,icon}) => {
  return (
   <label className="flex flex-col items-start gap-1 relative ">
    ...
    <div className="relative w-full flex items-center ">
      ...
      <input className='w-full border-[1px] border-secondary/40 outline-none p-2 rounded-lg pl-10 text-slate-500' type={type} placeholder={placeholder}  name={name}/>
